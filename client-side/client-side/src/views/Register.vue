    ...
    <div class="card card-container">
      ...
      <form name="form" @submit.prevent="handleRegister">
        <div class="form-group">
          ...
          v-validate="required"/>
          <div class="alert alert-danger" role="alert" v-if="errors.has('name')">Full Name is required.</div>
        </div>
        <div class="form-group">
          ...
          v-validate="required"/>
          <div class="alert alert-danger" role="alert" v-if="errors.has('username')">Username is required.</div>
        </div>
        <div class="form-group">
          ...
          v-validate="required"/>
          <div class="alert alert-danger" role="alert" v-if="errors.has('password')">Password is required.</div>
        </div> 
        <div class="form-group">
